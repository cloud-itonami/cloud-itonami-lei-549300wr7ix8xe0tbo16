...
This repository archives the publicly published legal/policy page of
Kinder Morgan, Inc., per
...
- **Company**: Kinder Morgan, Inc., LEI
  549300WR7IX8XE0TBO16, website `https://www.kindermorgan.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.kindermorgan.com/Legal`,
  retrieved-at `2026-07-10T06:28:13Z`, doc-type `:terms-of-service`.
