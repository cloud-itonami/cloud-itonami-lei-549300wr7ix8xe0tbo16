(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Kinder Morgan, Inc., LEI
  549300WR7IX8XE0TBO16) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Kinder Morgan, Inc."
   :website    "https://www.kindermorgan.com"})

(def ^:private demo-full-text
  "Legal Disclaimer\nThe materials and images contained on this web site are provided by Kinder Morgan, Inc. and its affiliates for informational purposes only, and are subject to change without notice. By accessing this energy-infrastructure company's site you agree to these terms, which are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.kindermorgan.com/Legal"
   :retrieved-at "2026-07-10T06:28:13Z"
